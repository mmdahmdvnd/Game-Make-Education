...
public class TDViewTappyDefP3 extends SurfaceView implements Runnable {
    ...
    // Game objects
    private PlayerShipTappyDefP3 player;
    public EnemyShipTappyDefP3 enemy1;
    public EnemyShipTappyDefP3 enemy2;
    public EnemyShipTappyDefP3 enemy3;
    public EnemyShipTappyDefP3 enemy4;
    public EnemyShipTappyDefP3 enemy5;

    // Make some random space dust
    ArrayList<SpaceDustTappyDefP3> dustList = new ArrayList<SpaceDustTappyDefP3>();
    ...
    TDViewTappyDefP3(Context context, int x, int y) {
        super(context);
    ...
    private void startGame(){
        ...
        player = new PlayerShipTappyDefP3(context, screenX, screenY);

        enemy1 = new EnemyShipTappyDefP3(context, screenX, screenY);
        enemy2 = new EnemyShipTappyDefP3(context, screenX, screenY);
        enemy3 = new EnemyShipTappyDefP3(context, screenX, screenY);
        if(screenX > 1000){
            enemy4 = new EnemyShipTappyDefP3(context, screenX, screenY);
        }
        if(screenX > 1200){
            enemy5 = new EnemyShipTappyDefP3(context, screenX, screenY);
        }
        ...
        for (int i = 0; i < numSpecs; i++) {
            // Where will the dust spawn?
        	SpaceDustTappyDefP3 spec = new SpaceDustTappyDefP3(screenX, screenY);
            dustList.add(spec);
        }
    ...
    private void update() {
        ...
        for (SpaceDustTappyDefP3 sd : dustList) {
