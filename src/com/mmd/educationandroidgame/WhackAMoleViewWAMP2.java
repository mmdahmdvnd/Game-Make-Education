...
public class WhackAMoleViewWAMP2 extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private WhackAMoleThread2 thread2;
	
	public WhackAMoleViewWAMP2(Context context, AttributeSet attrs) {
        super(context, attrs);

        SurfaceHolder holder = getHolder();
        holder.addCallback(this);

        thread2 = new WhackAMoleThread2(holder, context, new Handler() {
            @Override
	...
	public WhackAMoleThread2 getThread() {
		return thread2;
	}
	...
	class WhackAMoleThread2 extends Thread {
		
        public WhackAMoleThread2(SurfaceHolder surfaceHolder, Context context,
                Handler handler) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        return thread2.doTouchEvent(event);
    }
	
	@Override
	public void surfaceChanged(SurfaceHolder holder, int format, int width,
			int height) {
		thread2.setSurfaceSize(width, height);
	}
